...
def _find_tasks_in_file(file_name: str):
    ...
    # obsidian_uri = f"obsidian://open?path={urllib.parse.quote(file_name,safe='')}" # 2023-07-24, AR - Doesn't work as well between machines when ~ resolves to different paths.  Drop this line later
